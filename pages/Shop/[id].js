...
export async function getServerSideProps(context) {
    ...
    const res = await fetch(`${Constants.BASE_URL}/api/products-details-web/` + id)
        ...
        <div>    
            ...
            <div className="max-w-screen-2xl mx-auto px-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 flex flex-wrap items-start">
                    ...
                    <div>
                        <div className='mb-2'>
                            <img src={`${image_URL}/${product.primary_photo?.photo}`} className='w-full md:w-auto border' />
                        </div>
                        <div className=''>
                            <img src={`${image_URL}_thumb/${product.primary_photo?.photo}`} className='w-16 md:w-32 lg:w-48 border' />
                        </div>
                    </div>
                    {/* Image section end*/}
                    ...
                    <div>
                        ...
                        <div>
                            <div className="flex items-center mt-5 mb-2">
                                <CiStar className='text-yellow-800' />
                                <CiStar className='text-yellow-800' />
                                <CiStar className='text-yellow-800' />
                                <CiStar className='text-yellow-800' />
                                <CiStar className='text-yellow-800' />
                        ...
                        <div className='mt-5'>
                            ...
                            <span >Availability:<input type="checkbox" checked className='checked:bg-blue-500 ' /> In Stock {product.stock}</span> <br />
                            Size Chart <br />
                        </div>
