            ...
            <div className="bg-[#ddd]">
                <footer className="p-4 max-w-screen-xl mx-auto px-3  sm:p-6 dark:bg-gray-900 md:justify-between  sm:px-4 w-full z-20 left-0 ">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Copyright© 2023 <a href="https://hometex.ltd/" className="hover:underline"> by Hometex Bangladesh Manufactory</a>. All Rights Reserved.
                        </span>
