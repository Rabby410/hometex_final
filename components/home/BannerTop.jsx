        ...
        <div className="max-w-screen-2xl mx-auto px-3 mb-5 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="w-full max-w-sm  hover:bg-[#66666691] transition delay-150 duration-300 ease-in-out mt-[65px] ml-[54px] ">
                <div className="flex flex-col items-center pb-10 px-8 pt-8">
                    ...
                    <div className="flex mt-4 space-x-3 md:mt-6">
                        <a href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-[#ffd741] hover:text-[#ffd741] rounded-lg hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 uppercase">Shop now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="justify-items-center w-full max-w-sm hover:bg-[#66666691] transition delay-150 duration-300 ease-in-out mt-[65px] ml-[54px]">
                <div className="flex flex-col items-center pb-10 px-8 pt-8">
                    ...
                    <div className="flex mt-4 space-x-3 md:mt-6">
                        <a href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-[#ffd741] hover:text-[#ffd741] hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 uppercase">Shop now</a>
                        </div>
                </div>
            </div>
            </div>
